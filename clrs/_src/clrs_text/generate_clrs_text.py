...
This script generates a dataset of CLRS text samples.
"""
...
_DEFAULT_ALGO_AND_LENGTHS = config_dict.ConfigDict({
...
_ALGO_AND_LENGTHS = config_flags.DEFINE_config_dict(
    'algo_and_lengths',
    _DEFAULT_ALGO_AND_LENGTHS,
...
def main(_: Sequence[str]) -> None:
  ...
  for algo_name, lengths in tqdm.tqdm(_ALGO_AND_LENGTHS.value.items()):
    samples = []
